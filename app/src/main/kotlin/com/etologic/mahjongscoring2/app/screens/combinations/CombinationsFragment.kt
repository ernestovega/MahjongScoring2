    ...
    override val toolbarMenuProvider = object : MenuProvider {
        override fun onCreateMenu(menu: Menu, menuInflater: MenuInflater) {
            ...
            (menu.findItem(R.id.action_search_combination)?.actionView as? SearchView)?.apply {
                ...
                findViewById<TextView>(androidx.appcompat.R.id.search_src_text)?.setTextColor(
                    whiteColor
                )
            ...
            with(activity as? MainActivity) {
                when (menuItem.itemId) {
                    ...
                    R.id.action_toggle_combination_explanation -> {
                        val icon = if (rvAdapter.toggleImageOrDescription() === SHOW) R.drawable.ic_books else R.drawable.ic_photos
